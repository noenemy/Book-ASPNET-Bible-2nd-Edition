...
{
	/// <summary>
	/// Summary description for use_BulletList.
	/// </summary>
	public class use_BulletList : System.Web.UI.Page
	{
		...
		protected control_cs.dsCategories dsCategories1;
		protected CustomControl.BulletList BList1;
		...
		{    
			...
			this.dsCategories1 = new control_cs.dsCategories();
