...
Namespace localhost
    ...
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="ProductServiceSoap", [Namespace]:="http://tempuri.org/")>  _
    Public Class ProductService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://localhost/vb20/ProductService.asmx"
        End Sub
        ...
        Public Function GetCategories() As dsCategories
            ...
            Return CType(results(0),dsCategories)
        End Function
        
        '<remarks/>
        Public Function BeginGetCategories(ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetCategories", New Object(-1) {}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndGetCategories(ByVal asyncResult As System.IAsyncResult) As dsCategories
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),dsCategories)
        End Function
        
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetProductsByCategoryID", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetProductsByCategoryID(ByVal CategoryID As Integer) As dsProducts
            Dim results() As Object = Me.Invoke("GetProductsByCategoryID", New Object() {CategoryID})
            Return CType(results(0),dsProducts)
        End Function
        
        '<remarks/>
        Public Function BeginGetProductsByCategoryID(ByVal CategoryID As Integer, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("GetProductsByCategoryID", New Object() {CategoryID}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndGetProductsByCategoryID(ByVal asyncResult As System.IAsyncResult) As dsProducts
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),dsProducts)
        End Function
    End Class
    ...
    Public Class dsProducts
        ...
        Public Class ProductsDataTable
            ...
            Private Sub InitClass()
                ...
                Me.Constraints.Add(New UniqueConstraint("dsProductsKey1", New DataColumn() {Me.columnProductID}, true))
    ...
    Public Class dsCategories
        ...
        Public Class CategoriesDataTable
            ...
            Private Sub InitClass()
                ...
                Me.Constraints.Add(New UniqueConstraint("dsCategoriesKey1", New DataColumn() {Me.columnCategoryID}, true))
