<%@ Page language="c#" Codebehind="list.aspx.cs" AutoEventWireup="false" Inherits="guestbook_cs.list" %>
					...
					<ItemTemplate>
						<TABLE width="600">
							<TR bgColor="#66ff99">
								...
								<TD><FONT size="2">
										<asp:HyperLink id=HyperLink1 runat="server" NavigateUrl='<%# "mailto:" + DataBinder.Eval(Container, "DataItem.Email") %>' Text='<%# DataBinder.Eval(Container, "DataItem.Writer") %>'>
										</asp:HyperLink>님이
