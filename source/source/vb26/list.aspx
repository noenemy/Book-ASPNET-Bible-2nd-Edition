<%@ Page Language="vb" AutoEventWireup="false" Codebehind="list.aspx.vb" Inherits="board_vb.list"%>
			...
			<center><IMG height="20" src="images/title.gif" width="20" align="absMiddle"> &nbsp;&nbsp;<font size="3"><b><asp:label id="lblBoardTitle" runat="server"></asp:label></b></font>&nbsp;&nbsp;
				...
				<table width="600">
					<tr>
						...
						<td align="right"><INPUT id="hidBId" type="hidden" name="hidBId" runat="server">
							...
							</asp:dropdownlist><INPUT id="txtSearchKey" onkeydown="javascript:return OnSearchKeyDown();" maxLength="15" runat="server">
							<INPUT id="btnFind" onclick="javascript:OnSearch();" type="button" value="검색" runat="server">
							<INPUT id="btnSearchCancel" onclick="javascript:OnSearchCancel();" type="button" value="검색취소" runat="server">
						</td>
					</tr>
				</table>
				<asp:datalist id="DataList1" runat="server">
					...
					<ItemTemplate>
						<TR bgcolor="#ccffff">
							<TD align="right">
								<asp:Label id=lblCId1 runat="server" Text='<%# ShowNumber(DataBinder.Eval(Container, "DataItem.c_id"),DataBinder.Eval(Container, "DataItem.c_step")) %>'>
								</asp:Label></TD>
							<TD>
								<asp:Image id=imgFile1 runat="server" ImageUrl='<%# ShowFileImage(DataBinder.Eval(Container, "DataItem.filename").ToString()) %>'>
								</asp:Image></TD>
							<TD>
								<asp:Label id=lblDepth1 runat="server" Text='<%# ShowDepth(DataBinder.Eval(Container, "DataItem.c_depth")) %>'>
								</asp:Label>
							...
							<TD align="center">
								<asp:Label id=lblRegDate1 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.regdate").ToShortDateString() %>'>
								</asp:Label></TD>
							<TD align="center">
					...
					<AlternatingItemTemplate>
						<TR>
							<TD align="right">
								<asp:Label id=lblCId2 runat="server" Text='<%# ShowNumber(DataBinder.Eval(Container, "DataItem.c_id"),DataBinder.Eval(Container, "DataItem.c_step")) %>'>
								</asp:Label></TD>
							<TD>
								<asp:Image id=imgFile2 runat="server" ImageUrl='<%# ShowFileImage(DataBinder.Eval(Container, "DataItem.filename").ToString()) %>'>
								</asp:Image></TD>
							<TD>
								<asp:Label id=lblDepth2 runat="server" Text='<%# ShowDepth(DataBinder.Eval(Container, "DataItem.c_depth")) %>'>
								</asp:Label>
							...
							<TD align="center">
								<asp:Label id=lblRegDate2 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.regdate").ToShortDateString() %>'>
								</asp:Label></TD>
							<TD align="center">
				...
				<table width="600">
					...
					<tr>
						<td align="middle"><asp:hyperlink id="lnkWrite" runat="server" ImageUrl="images/write.gif">글쓰기</asp:hyperlink><asp:hyperlink id="lnkPrev" runat="server" ImageUrl="images/previous.gif">이전 페이지</asp:hyperlink><asp:hyperlink id="lnkNext" runat="server" ImageUrl="images/next.gif">다음 페이지</asp:hyperlink></td>
					</tr>
				</table>
			</center>
		</form>
