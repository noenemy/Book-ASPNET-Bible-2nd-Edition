<%@ Page language="c#" Codebehind="db_login.aspx.cs" AutoEventWireup="false" Inherits="security_cs.db_login" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>db_login</title>
	...
	<body>
		<form id="db_login" method="post" runat="server">
			<P><FONT face="굴림">Login 페이지(Forms 인증 - DB이용)</FONT></P>
