...
{
	/// <summary>
	/// Summary description for col_database.
	/// </summary>
	public class col_database : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.DataGrid grdDatabase;
		...
		protected databinding_cs.dsCategories dsCategories1;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				// DataSet을 채우고 DataGrid 컨트롤 데이터바인딩
		...
		{    
			...
			this.dsCategories1 = new databinding_cs.dsCategories();
