...
// 
namespace wa_pratice_cs.localhost {
    ...
    public class ProductService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ProductService() {
            this.Url = "http://localhost/cs20/ProductService.asmx";
        }
        ...
        /// <remarks/>
        public dsCategories EndGetCategories(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((dsCategories)(results[0]));
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetProductsByCategoryID", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public dsProducts GetProductsByCategoryID(int CategoryID) {
            object[] results = this.Invoke("GetProductsByCategoryID", new object[] {
                        CategoryID});
            return ((dsProducts)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginGetProductsByCategoryID(int CategoryID, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetProductsByCategoryID", new object[] {
                        CategoryID}, callback, asyncState);
        }
        
        /// <remarks/>
        public dsProducts EndGetProductsByCategoryID(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((dsProducts)(results[0]));
        }
    }
    ...
    public class dsCategories : DataSet {
        ...
        public class CategoriesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("dsCategoriesKey1", new DataColumn[] {
    ...
    public class dsProducts : DataSet {
        ...
        public class ProductsDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("dsProductsKey1", new DataColumn[] {
